...
class EnvironmentRenderWidget(QWidget):
    ...
    def show_placeholder(self, env_name: str = ""):
        ...
        name_display = env_name if env_name else "No Environment"
        
        # Create a dark placeholder pixmap with text
        w, h = self._frame_label.width() or 400, self._frame_label.height() or 300
        pixmap = QPixmap(w, h)
        pixmap.fill(QColor("#0a0c12"))
        ...
        font = QFont(FONT_FAMILY.split(",")[0].strip(), 14)
